...
echo -e "   - Para dudas sobre el uso del bot, revisa los comandos y menú descritos en el README."
echo -e "   - Si el servicio systemd no funciona, revisa los logs con: journalctl -u loanbot.service -f"
echo -e "   - Puedes iniciar, detener o reiniciar el bot con systemctl (ejemplo: systemctl start loanbot.service)"
echo ""
